...
int bullet_collided_with_enemies(Enemies* enemies, Type who_shot_type, int who_shot_id, float cx, float cy, float radius, Scoreboard* scoreboard)
{
	void* arg[] = {&cx, &cy, &radius, &who_shot_id, &who_shot_type, scoreboard};
