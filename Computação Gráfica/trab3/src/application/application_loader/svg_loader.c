...
{ 
    ...
    {
        append_big_hurdle(svg->app, new_hurdle(svg->r, svg->cx, svg->cy, svg->red, svg->green, svg->blue));
    }
    else if(is_green(svg->red, svg->green, svg->blue))
    {
        set_player(svg->app, new_player(svg->r, svg->cx, svg->cy, svg->red, svg->green, svg->blue));
    }
    ...
    {
        append_small_hurdle(svg->app, new_hurdle(svg->r, svg->cx, svg->cy, svg->red, svg->green, svg->blue));
    }
    else
    {
