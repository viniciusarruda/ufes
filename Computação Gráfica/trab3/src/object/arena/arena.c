...
void display_arena(void* arena)
{
	glPushMatrix();
		...
		display_circle(cast(arena, Arena)->outer_radius, cast(arena, Arena)->outer_red, cast(arena, Arena)->outer_green, cast(arena, Arena)->outer_blue);
		display_circle(cast(arena, Arena)->inner_radius, cast(arena, Arena)->inner_red, cast(arena, Arena)->inner_green, cast(arena, Arena)->inner_blue);
